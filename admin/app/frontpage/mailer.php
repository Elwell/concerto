...
<div class="roundcont">
  ...
  <form action="<?php echo ADMIN_URL?>/frontpage/sendmail" method="POST">
    <h1>Users</h1>
<?php
...
?>
    ...
    <br />
    <h1>From</h1>
    <input type="radio" name="from" value="system" checked="checked"> Concerto System (<?php echo SYSTEM_EMAIL ?>)
    <input type="radio" name="from" value="user"> <?php echo $this->fromyou ?>
    <br />
    <br />
    <h1>Subject</h1>
