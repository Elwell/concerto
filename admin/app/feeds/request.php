...
<p>Feeds in Concerto are broad categories for content submission.  Most content at should fit into one of our <a href="<?php echo ADMIN_URL?>/browse">existing feeds</a>, but if you think your content fits into a specific category that should be separate from existing feeds on Concerto, we'd love to hear about it.</p>
<p>See the <a href="<?php echo ADMIN_URL?>/pages/show/docs">Support Center</a> for more information about feeds.</p>
