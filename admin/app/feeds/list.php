...
<h2>Click on a feed for more information. <a href="<?php echo ADMIN_URL ?>/pages/show/docs/23"><img class="icon" border="0" src="<?php echo ADMIN_BASE_URL ?>images/help_button.gif" alt="Extra Help" title="Extra Help" /></a></h2>
...
?>
  <tr><td>
    <h1><a href="<?php echo ADMIN_URL?>/feeds/show/<?php echo $feed->id ?>"><?php echo $feed->name ?></a></h1>
    <?php if (strlen($feed->description)>0) { ?>
