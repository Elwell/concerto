...
<?php } ?>
<a href="<?php echo ADMIN_URL.'/browse/show/'.$this->feed->id ?>"><span class="buttonsel"><div class="buttonleft"><img src="<?php echo ADMIN_BASE_URL ?>/images/buttonsel_left.gif" border="0" alt="" /></div><div class="buttonmid"><div class="buttonmid_padding">Browse Feed</div></div><div class="buttonright"><img src="<?php echo ADMIN_BASE_URL ?>/images/buttonsel_right.gif" border="0" alt="" /></div></span></a>

<div style="clear:both;height:12px;"></div>
<h3>Feed Name: <span class="emph"><?php echo $this->feed->name ?></span></h3>
<h3>Group: <span class="emph"><a href="<?php echo ADMIN_URL.'/groups/show/'.$this->group->id?>"><?php echo $this->group->name ?></a></span></h3>
<?php if (strlen($this->feed->description)>0) { ?>
<h3>Description: </h3>
<p><?php echo $this->feed->description ?></p>
<?php } ?>
<h3>Feed Statistics:</h3>
<p><a href="<?php echo ADMIN_URL."/browse/show/{$this->feed->id}"?>">Active and Future Content: <?php echo $this->active_content ?></a></p>
<p><a href="<?php echo ADMIN_URL."/browse/show/{$this->feed->id}/expired"?>">Expired Content: <?php echo $this->expired_content ?></a></p>
